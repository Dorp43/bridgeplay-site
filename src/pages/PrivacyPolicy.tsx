...
export default function PrivacyPolicy() {
    ...
    return (
        <LegalLayout title="Privacy Policy" lastUpdated="August 21, 2026">
            ...
            <ul>
                <li><strong>Google Firebase</strong> — account authentication (Firebase Auth) and data storage (Firestore) for your email, device hash, licence state, and the purchase records in section 3. Subject to Google's privacy policy.</li>
